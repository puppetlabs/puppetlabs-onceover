...
- (CAT-2776) Flip runtime dependency from openvox to puppet; fix env var name [#7](https://github.com/puppetlabs/puppetlabs-onceover/pull/7) ([actowery](https://github.com/actowery))
